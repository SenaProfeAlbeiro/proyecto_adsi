...
<body>
	<div class="container">
		...
		<!-- Navegador -->
		<nav class="vendedor row sticky-top d-flex">
			...
			<aside id="panel-lateral" class="col-12 col-lg-3 p-0">
				...
				<div id="modulos" class="modulos col-12 p-0">
					<div class="accordion" id="accordionExample">
						<div class="card">
							<div class="vendedor card-header p-1 p-lg-0" id="headingOne">
								<h2 class="mb-0">
						...
						<div class="card">
							<div class="vendedor card-header p-1 p-lg-0" id="headingTwo">
								<h2 class="mb-0">
						...
						<div class="card">
							<div class="vendedor card-header p-1 p-lg-0" id="headingThree">
								<h2 class="mb-0">
						...
						<div class="card">
							<div class="vendedor card-header p-1 p-lg-0" id="headingFour">
								<h2 class="mb-0">

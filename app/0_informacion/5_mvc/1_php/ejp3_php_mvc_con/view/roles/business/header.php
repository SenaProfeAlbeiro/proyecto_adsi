					...
					<div class="modal-body">
						<form id="enviar" action="?c=Login" method="POST">
							<div class="form-group">
								...
								<input type="email" name="usuario" class="form-control" id="usuario" aria-describedby="emailHelp" placeholder="correo@correo.com" value="<?php echo $user ?>" pattern="[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*@[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{2,5}" title="No es un correo válido" required>
							</div>
							<div class="form-group">
								<label for="contrasena">Contraseña</label>
								<input type="password" name="pass" class="form-control" id="contrasena"
								placeholder="Entre 5 y 8 caracteres" value="<?php echo $pass ?>" pattern="[A-Za-z0-9]{5,8}" title="Escriba entre 5 y 8 caracteres" maxlength="8" required>
							</div>							
